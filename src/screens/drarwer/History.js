  ...
  render() {
    return (
      <View style={styles.container}>
        <DrawerHeader title={'History'} callBack={() => {
        ...
        <View style={styles.requestTitleParentView}>
         ...
         <View style={{width: width * 0.1}}>
          ...
          <View style={{width: width * 0.1}}>
          <Text style={styles.requestTitleText}>Start Time</Text>
          </View>
          <View style={{width: width * 0.1}}>
          <Text style={styles.requestTitleText}>Duration</Text>
          </View>
          <View style={{width: width * 0.1}}>
          <Text style={styles.requestTitleText}>Action</Text>
          </View>
        </View>
                ...
                <View>
                  {
                    ...
                    <View style={{
                      ...
                      <View style={{width: width * 0.1}}>
                        <Text style={{flexShrink: 1}}>{item.date}</Text>
                      </View>
                      <View style={{width: width * 0.1}}>
                        <Text style={{flexShrink: 1}}>{item.status}</Text>
                      </View>
                      <View style={{width: width * 0.1}}>
                        <Text style={{flexShrink: 1}}>{item.startTime}</Text>
                      </View>
                      <View style={{width: width * 0.1}}>
                        <Text style={{flexShrink: 1}}>{item.duration}</Text>
                      </View>
                      <View style={{
                        ...
                        <Text style={{color: '#FFFFFF'}}>{item.action}</Text>
                      </View>
